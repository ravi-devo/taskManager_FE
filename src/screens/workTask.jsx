...
const WorkTask = () => {
    ...
    const handleFilter = (currentStatus) => {
        let tempArray = taskItems.filter((task) => task.category === 'Work');
    ...
    useEffect(() => {
        const workTasks = taskItems.filter((task) => task.category === 'Work');
    ...
    return (<>
        <div>
            <Header />
            <h5 className="my-2">Your work task will appear here</h5>
